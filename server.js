...
io.on('connection', (socket)The edit_file corrupted the server.js. Let me fix it by rewriting the full file:

<create_file>
<absolute_path>C:/Users/infin/Downloads/echo-vault-backend/server.js</absolute_path>
...
// Session middleware (required for Passport)
app.use(session({
  secret: process.env.SESSION_SECRET || 'echovault-session-secret',
  resave: false,
  saveUninitialized: false,
