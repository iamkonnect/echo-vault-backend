              ...
              child: Form(
                ...
                child: Column(
                  children: [
                    ...
                    const Text(
                      'Artist Login - EchoVault',
                      style: TextStyle(fontSize: 28, fontWeight: FontWeight.bold, color: Colors.white),
                    ),
                    const Text('Access your dashboard', style: TextStyle(color: Colors.white70)),
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        ...
                        child: _isLoading
                            ...
                            : const Text('LOGIN AS ARTIST', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
                      ),
                    ),
                  ],
                ),
